                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="phone"
                                                        type="number  @error('name') is-invalid @enderror" name="phone"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control @error('name') is-invalid @enderror" id="address"
                                                type="text" name="address" value="{{ old('address') }}"
                                                autocomplete="name" placeholder="Your address" />
